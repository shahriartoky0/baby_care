...
class AddPumping extends StatelessWidget {
  AddPumping({super.key});
                ...
                : Container(
                  ...
                  child: PrimaryButton(
                    ...
                    onPressed: () {
                      ...
                      Get.to(() => PumpingTimeSavingScreen(), arguments: breastFeedingTiming);
                    },
                  ),
                ),
      ),
                    ...
                    controller.seconds.value == 0
                        ? Center(
                          child: TextButton.icon(
                            onPressed: () {
                              Get.to(() => PumpingManualTimeScreen());
                            },
                            label: Text(
                              'Manual Entry',
